...
%\begin{figure}[b!]
%\centering
%\includegraphics[width = .8\textwidth]{SOMETHING.PDF}\\
...
%\begin{figure}[b!]
%\centering
%\includegraphics[width = .8\textwidth]{OURFIGURE1.PDF}\\
%\caption{Replication of Figure 2 ("Box-and-whisker plots of the three components of $\beta_{2}, estimated from 500 independent runs of length $n = 100$", from left to right (batch EM, online EM  with $\gamma_{i} = 1/i$, online EM with $\gamma_{i} = 1/i^{0.6}$, and online EM with $\gamma_{i} = 1/i^{0.6}$ with averaging starting from the 50th iteration} \label{f2}
%\end{figure}

%\begin{figure}[b!]
%\centering
%\includegraphics[width = .8\textwidth]{OURFIGURE2.PDF}\\
%\caption{Replication of Figure 2 ("Box-and-whisker plots of the three components of $\beta_{2}, estimated from 500 independent runs of length $n = 100$", from left to right (batch EM, online EM  with $\gamma_{i} = 1/i$, online EM with $\gamma_{i} = 1/i^{0.6}$, and online EM with $\gamma_{i} = 1/i^{0.6}$ with averaging starting from the 50th iteration} \label{f2}
%\end{figure}
...
%\doublespacing
%\centering
%\includegraphics[width = .8\textwidth]{OURFIGURE3.PDF}\\
%\caption{Replication of Figure 3 ("Same plots as in Figure 2 for signals of length n = 10,000$"), NOTE: We ran batch EM 50 times} \label{f2}
%\end{figure}
...
%\doublespacing
%\centering
%\includegraphics[width = .8\textwidth]{OURFIGURE4.PDF}\\
%\caption{Replication of Figure 4 ("Examples of parameters trajectories for the three components of $\beta_{2}$" where DESCRIPTION OF HOW YOU LABELED THE GRAPH)} \label{f2}
%\end{figure}
